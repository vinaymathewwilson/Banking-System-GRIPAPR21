...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center">NEW INDIAN TRANSFER</a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:#ff3333;border-radius:10px;color:white" >
              <form method="POST">
...
?>
                    ...
                    <h3>Transfer Details</h3>
                        ...
                        <img src="logoo.png" style="width:130px;height:60px;">
                    </div>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="logoo.png" style="width:250px;height:220px;margin-top:40px;">
                   <button  name="submit" style="margin-top:10px;">Proceed to Pay</button>
                  </div>
             </div>
          </div>
